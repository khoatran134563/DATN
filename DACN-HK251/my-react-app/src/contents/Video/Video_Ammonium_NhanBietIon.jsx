...
const VIDEO_SRC = 'https://www.youtube.com/embed/L9mR5yfpB1c'; 

const Video_Ammonium_NhanBietIon = () => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
              ...
              <p className="text-gray-600 text-sm leading-6">
                Minh họa cách nhận biết ion NH₄⁺ trong dung dịch muối ammonium.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 text-sm leading-6">
                Có khí ammonia thoát ra, làm quỳ tím ẩm chuyển màu xanh.
              </p>
            </div>
        ...
        <div className="bg-yellow-50 p-5 rounded-xl border border-yellow-100 h-fit">
          ...
          <p className="text-sm text-yellow-700 leading-relaxed">
            Dấu hiệu nhận biết ion ammonium là tạo khí NH₃ khi tác dụng với dung dịch kiềm.
          </p>
        </div>
      </div>
    </div>
...
export default Video_Ammonium_NhanBietIon;