  ...
  return (
    <aside className="w-64 bg-[#f0f2f5] border-r border-gray-200 fixed h-full overflow-y-auto hidden md:block top-16 pb-20 scrollbar-thin scrollbar-thumb-gray-300">
      <nav className="mt-4 space-y-1">
            ...
            <span className="flex items-center gap-2">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6z"
                />
              </svg>
              Bảng tuần hoàn
            </span>
        ...
        {/* === MỤC ĐẶC BIỆT: Sách giáo khoa tương tác === */}
        <div>
          <button
            ...
            className={`w-full flex justify-between items-center px-4 py-3 font-semibold text-sm border-l-4 transition-all duration-200 text-left
              ${
                activeCategory === 'textbook'
                  ? 'bg-gradient-to-r from-blue-700 to-indigo-700 text-white border-blue-700 shadow-md'
                  : 'text-slate-700 border-transparent hover:bg-gray-200'
              }`}
          >
            <span className="flex items-center gap-2">
                              ...
                              chapter.lessons.map((lesson) => (
                                <div key={lesson.id}>
                                  ...
                                  >
                                    ...
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      className={`h-3 w-3 transition-transform duration-200 flex-shrink-0 opacity-70 ${
                                        expandedLesson === lesson.id
                                          ? 'rotate-180'
                                          : ''
                                      }`}
                                    ...
                                    <div className="bg-white py-1 shadow-inner">
                                      {lesson.topics &&
                                        lesson.topics.map((topic, tIndex) => (
                                          ...
                                          >
                                            <span className="mt-1.5 mr-2 text-[6px] text-blue-400 flex-shrink-0">
                                              ●
                                            </span>
